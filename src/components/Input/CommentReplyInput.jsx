...
const CommentReplyInput = ({
  ...
  return (
    <div className="pl-8 flex items-center w-full gap-2 mb-10">
      <img
        src={
      ...
      <div className="flex gap-2">
        <textarea
          ...
          className={`py-2 px-3 w-[17rem] ${
            image ? "w-48 md:w-72" : "w-56"
          } text-[10px] bg-searchInput border border-[#262626] rounded-md text-textPrimary overflow-auto h-16 cursor-text text-sm  placeholder:text-slate-300 placeholder:text-sm focus:border-[#2d2d2d] focus:outline focus:ring-0`}
