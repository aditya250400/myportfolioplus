...
import { setCurrentComment, setCurrentCommentReply, setStatusEditComment, setStatusEditCommentReply } from "../../states/comments/commentsSlice";
import placeholderPhotoProfile from '../../assets/images/placeholderPhotoProfile.png';
import { updateCommentAsync, updateCommentReplyAsync } from "../../states/comments/commentsThunk";

const CommentReplyEditInput = ({
  myProfile, postId}) => {
    const {currentCommentReply, loadingWhenUpdatingComment} = useSelector((state) => state.comments);
    const [content, setContent] = useState(currentCommentReply?.content || "");
    ...
    const onEdit = () => {
      if (content !== "") {
        dispatch(
          updateCommentReplyAsync({
            content: content,
            setContent,
            comment_id: currentCommentReply.comment_id,
            post_id: postId,
            id: currentCommentReply.id
          })
        );
  ...
  return (
   <div className="flex flex-col gap-1 mb-2 pl-8">
...
export default CommentReplyEditInput;
